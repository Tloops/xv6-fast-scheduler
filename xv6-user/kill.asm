...
main(int argc, char **argv)
{
  ...
  34:	33e080e7          	jalr	830(ra) # 36e <kill>
  for(i=1; i<argc; i++)
  ...
  4c:	84058593          	addi	a1,a1,-1984 # 888 <malloc+0xe4>
  50:	4509                	li	a0,2
  52:	00000097          	auipc	ra,0x0
  56:	664080e7          	jalr	1636(ra) # 6b6 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	44e88893          	addi	a7,a7,1102 # 8a0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 524:	380b8b93          	addi	s7,s7,896 # 8a0 <digits>
 ...
 660:	25c48493          	addi	s1,s1,604 # 8b8 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 728:	19c78793          	addi	a5,a5,412 # 8c0 <__bss_start>
 72c:	639c                	ld	a5,0(a5)
 ...
 758:	00e6ea63          	bltu	a3,a4,76c <free+0x52>
{
 ...
 79a:	12f73523          	sd	a5,298(a4) # 8c0 <__bss_start>
}
 79e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d0:	0f478793          	addi	a5,a5,244 # 8c0 <__bss_start>
 7d4:	6388                	ld	a0,0(a5)
 ...
 7fa:	0ca48493          	addi	s1,s1,202 # 8c0 <__bss_start>
  if(p == (char*)-1)
 7fe:	5b7d                	li	s6,-1
 800:	a0b5                	j	86c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 802:	00000717          	auipc	a4,0x0
 806:	0c670713          	addi	a4,a4,198 # 8c8 <base>
 80a:	e398                	sd	a4,0(a5)
 80c:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 830:	08a73a23          	sd	a0,148(a4) # 8c0 <__bss_start>
      return (void*)(p + 1);
